...
class Scene(models.Model):
    ...
    challenge = models.TextField(blank=True, null=True, validators=[safe_text_validator])
    setting = models.TextField(blank=True, null=True, validators=[safe_text_validator])
    plot_twist = models.TextField(blank=True, null=True, validators=[safe_text_validator])
    clue = models.TextField(blank=True, null=True, validators=[safe_text_validator])
