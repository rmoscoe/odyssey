...
export default function Adventure({ adventure, handleDeleteClick }: AdventureProps) {
    ...
    const handleTileClick = () => {
        navigate(`/adventures/${id}`, { state: { id, title, created_at, last_modified, game, campaign_setting, exposition, incitement, scene_set, climax, climax_progress, denoument, progress, status } });
    }
